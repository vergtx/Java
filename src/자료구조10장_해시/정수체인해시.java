...
class SimpleChainHash { // 노드 클래스 정의
	private int size; // 해시 테이블의 크기
	private Node[] table; // 해시 테이블 (노드들의 배열)
	...
	public int add(int key) {
		int hash = hashValue(key) % 10; // size 가 10 이라서 10 으로 나눠 줌 // 추가할 데이터의 해시값
...
public class 정수체인해시 {
	enum Menu {
		...
		static Menu MenuAt(int idx) { // 순서가 idx번째인 열거를 반환 // 일본식코딩법
